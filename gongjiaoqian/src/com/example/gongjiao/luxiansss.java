 ...
 */
public class luxiansss extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.luxiansss);
        EditText editCity = (EditText) findViewById(R.id.city);
        editCity.setText(SharedPreferencesUtils.getParam(luxiansss.this, "city","北京").toString());
    ...
    public void searchButtonProcess() {
        ...
        mSearch.searchInCity((new PoiCitySearchOption()).city(
                editCity.getText().toString())
                        .keyword(getIntent().getStringExtra("luxian")));
    }
    ...
    public void onGetBusLineResult(BusLineResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(luxiansss.this, "抱歉，未找到结果",
        ...
        Toast.makeText(luxiansss.this, result.getBusLineName(),
