		...
		<div class="crumb-wrap">
			<div class="crumb-list">
				<i class="icon-font"></i><a href="index.html">首页</a><span
					class="crumb-step">&gt;</span><span class="crumb-name">公交司机</span>
					</div>
				</div>
			...
			<form action="${pageContext.request.contextPath}/wenti/dao" method="post">
				<div class="result-title">
					<div class="result-list">
						<a href="${pageContext.request.contextPath}/gjsj_add.jsp" target="main"><i
					...
					<table class="result-tab" width="100%">
						...
						<c:forEach var="x" items="${list}" varStatus="status">
							...
							<tr>
								...
								<td>${x.pass}</td>
								<td>  <a class="link-del"
									href="${pageContext.request.contextPath}/main/delgjsj?id=${x.id}">删除</a>
									</td>
							</tr>
						</c:forEach>
					</table>
