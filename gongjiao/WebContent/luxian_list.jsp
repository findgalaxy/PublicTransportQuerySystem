		...
		<div class="crumb-wrap">
			<div class="crumb-list">
				<i class="icon-font"></i><a href="index.html">首页</a><span
					class="crumb-step">&gt;</span><span class="crumb-name">路线信息</span>
					</div>
				</div>
			...
			<form action="${pageContext.request.contextPath}/wenti/dao" method="post">
				<div class="result-title">
					<div class="result-list">
						<a href="${pageContext.request.contextPath}/luxian_add.jsp" target="main"><i
							class="icon-font"></i>新增路线</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>
					...
					<table class="result-tab" width="100%">
						...
						<c:forEach var="x" items="${list}" varStatus="status">
							...
							<tr>
								...
								<td>${x.name}</td>
								<td>  <a class="link-del"
									href="${pageContext.request.contextPath}/main/dellx?id=${x.id}">删除</a>
									<a class="link-del"
									href="${pageContext.request.contextPath}/main/findzd?id=${x.id}">路线站点</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
